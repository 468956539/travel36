<template>
    <div class="hot-module1">
        ...
        <div class="col-1">
            ...
            <ul class="more">
                <li>
                    <a href="https://m.ly.com/public/destination" title="更多"><i></i><i></i><i></i></a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-2">
            <ul>
                ...
                <li>
                    <a href="https://m.ly.com/go/journeytopic/385/2150.html?from=hotplay" rel="nofollow" onclick="_tcTraObj._tcTrackEvent('touchhome_B','img','/hot-playing','locCid=324&amp;pos=1&amp;title=今年最火的10大古镇&amp;date=20180319')">
            ...
            <a class="more-link" href="https://m.ly.com/go/youji/view/gonglueIndex.html?fid=8" onclick="_tcTraObj._tcTrackEvent('touchhome_B','txt','/hot-more','locCid=324&amp;txt=查看更多玩法&amp;date=20180319')">查看更多玩法</a></div>
    </div>
</template>
...
<style scoped>
    ...
    .hot-module1 h2 em{
        background: url(//pic5.40017.cn/01/000/5f/b5/rBLkBlqo1SmAXKh2AAATQxd5x9Q718.png) no-repeat 0 0;
        background-size: 3.9rem 2.8rem;
        background-position: -.32rem -1.10667rem;
    }

    .hot-module1 .col-1 {
        padding: .53333rem .13333rem .26667rem .4rem;
        border-bottom: .01333rem solid #f5f5f5;
        overflow: hidden;
    }

    .hot-module1 .col-1 .more li i{
        width: .1rem;
        height: .1rem;
        background: #979797;
        display: inline-block;
    ...
    .hot-module1 .col-2 {
        padding: .4rem .13333rem .53333rem .4rem;
        border-bottom: .01333rem solid #f5f5f5;
        overflow: hidden;
    }

    .hot-module1 .col-2 ul{
        display: table;
       
    }

    .hot-module1 .col-2 ul li {
        width: 50%;
        height: 2.2rem;
        float: left;
        display: block;
    ...
    .hot-module1 .col-2 ul li a img {
        width: 100%;
        height: 100%;
        border-radius: .10667rem;
    }

    .hot-module1 .col-2 ul li span {
        position: absolute;
        top: 0;
        left: 0;
        padding-right: .4rem;
    ...
    .hot-module1 .col-2 ul li span b {
        height: .4rem;
        line-height: .4rem;
        font-size: .24rem;
    ...
    .hot-module1 .col-2 ul li span i {
        position: absolute;
        display: inline-block;
        width: 0;
        height: 0;
        right: .01333rem;
        top: 0;
        border-top: .4rem solid #fc5446;
        border-right: .4rem solid transparent;
        z-index: 3;
    }

    .hot-module1 .col-2 ul li p {
        height: .36rem;
        line-height: .36rem;
        font-size: .24rem;
